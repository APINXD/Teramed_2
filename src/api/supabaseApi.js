...
export async function uploadPhoto(file) {
    ...
    const url = `https://iilgcfvsqtmnnxtpaque.supabase.co/storage/buckets/images/${folder}/${fileName}`;

    const anonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlpbGdjZnZzcXRtbm54dHBhcXVlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUxNDUyNDEsImV4cCI6MjA2MDcyMTI0MX0.aGVnxW-oogRpGi_fWabrCXGuXclT4z-TZxq00eh5lW4';
